...
namespace CSF.Validation.Rules
{
    ...
    /// <remarks>
    /// <para>
    /// Internally, this rule combines the <see cref="NotNull"/> &amp; <see cref="NotEmpty"/> rules into one.
    /// </para>
    /// <para>
    /// This rule will always return a synchronous result.
    /// </para>
    /// </remarks>
    public class NotNullOrEmpty : IRule<ICollection>, IRule<IEnumerable>, IRule<ICollection<object>>, IRule<Array>
    {
