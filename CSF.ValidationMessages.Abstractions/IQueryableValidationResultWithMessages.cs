...
namespace CSF.ValidationMessages
{
    ...
    /// This is very similar to <see cref="Validation.IQueryableValidationResult"/> but returns validation
    /// rules results that have message support.
    /// </summary>
    public interface IQueryableValidationResultWithMessages
    {
        ...
        IEnumerable<ValidationRuleResultWithMessage> QueryByMember<TValidated>(Expression<Func<TValidated, object>> memberAccessor,
                                                                               ...
                                                                               Validation.Rules.RuleOutcome outcome = default);
        ...
        IEnumerable<ValidationRuleResultWithMessage> Query(object objectIdentity = null,
                                                           string ruleTypeName = null,
                                                           string ruleName = null,
                                                           Validation.Rules.RuleOutcome outcome = default);
    }
