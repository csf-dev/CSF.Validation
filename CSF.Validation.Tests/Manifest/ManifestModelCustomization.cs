...
namespace CSF.Validation.Manifest
{
    ...
    public class ManifestModelCustomization : ICustomization
    {
        ...
        {
            fixture.Customize<ManifestItem>(c => c.FromFactory((ManifestValue v) => v).OmitAutoProperties());
            ...
            fixture.Customize<ManifestPolymorphicType>(c => c.Without(x => x.Parent).Without(x => x.Children).Without(x => x.Rules).Without(x => x.CollectionItemValue).Without(x => x.PolymorphicTypes));
