...
namespace CSF.Validation.Json
{
    [TestFixture,Parallelizable]
    public class JsonManifestModelSerializerTests
    {
        ...
        [Test,AutoMoqData]
        public void SerializeManifestModelAsyncShouldProduceExpectedJson(JsonManifestModelSerializer sut)
        {
            Assert.That(async () => await sut.SerializeManifestModelAsync(model), Is.EqualTo(serialized));
        }

        [Test,AutoMoqData]
        public async Task DeserializeManifestModelAsyncShouldProduceExpectedModel(JsonManifestModelSerializer sut)
        {
            var result = await sut.DeserializeManifestModelAsync(serialized);
