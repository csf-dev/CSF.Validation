...
namespace CSF.Validation.RuleExecution
{
    ...
    public class RuleDependencyTrackerFactory : IGetsRuleDependencyTracker
    {
        ...
        public ITracksRuleDependencies GetDependencyTracker(IEnumerable<ExecutableRuleAndDependencies> allRules, ResolvedValidationOptions options)
            => new RuleDependencyTracker(allRules);
    }
}